...
In our case, the outcome Y is binary. Let Y = 0 is for controls, Y = 1 is for cases. The predictors X are the genotypes we saw in the previous section: AA (X = 0), AB (X = 1), and BB (X = 2).
